...
public class Page9 : VBoxContainer, ILocalizable, ITextResponse, IPage
{
    public new string Name { get { return nameof(Page9); } }
    ...
    public void Localize(Language language)
    {
        ...
        if (language == Language.English)
        {
            ...
            label2.BbcodeText = "[center]\nPredict what will happen after lots of generations if the initial population of mice all has dark-colored fur?";
        ...
        else if (language == Language.Spanish)
        {
            ...
            label2.BbcodeText = "[center]\n¿Qué predices que sucederá después de muchas generaciones si la población inicial de ratones tiene todo el pelaje de color oscuro?";
    ...
    public bool CanAdvance()
    {
        ...
        return (text.Text.Length > 0 && !String.IsNullOrWhiteSpace(text.Text) && text2.Text.Length > 0 && !String.IsNullOrWhiteSpace(text2.Text));
    }
